...
var author$project$Main$daily5mgDosageInstruction = F2(
	function (model, weight) {
		...
		if (_n0.$ === 1) {
			...
			return _Utils_Tuple3(
				initialStr,
				A2(elm$core$Maybe$withDefault, '', note),
				followingStr);
		}
	});
			...
			var nextDose = function () {
				if (area.$ === 1) {
					...
					switch (area.a) {
						case 2:
							var _n3 = area.a;
							return 'Give next dose 48 hours after initial dose';
						case 1:
							var _n4 = area.a;
							return 'Give next dose 36 hours after initial dose';
						case 0:
							var _n5 = area.a;
							return 'Give next dose 24 hours after initial dose';
						default:
							var _n6 = area.a;
							return 'Resume regimen once gentamicin levels fall to < 1mg/L';
					}
				}
			}();
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Initial dose')
							])),
						A2(
						elm$html$Html$td,
						_List_Nil,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Further doses')
							])),
						A2(
						elm$html$Html$td,
						_List_Nil,
