...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aA: 'hidden', C: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aA: 'mozHidden', C: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aA: 'msHidden', C: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aA: 'webkitHidden', C: 'webkitvisibilitychange' }
		: { aA: 'hidden', C: 'visibilitychange' };
}
...
var author$project$Main$init = {A: elm$core$Maybe$Nothing, D: 1, E: 0, o: elm$core$Maybe$Nothing, G: elm$core$Maybe$Nothing, w: 1, s: elm$core$Maybe$Nothing};
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$value(ageStr),
...
var author$project$Main$idealBodyWeight = function (_n0) {
	...
	if (!height.$) {
		...
		return elm$core$Maybe$Just(constant + (2.3 * heightOverFiveFeet));
	} else {
		return elm$core$Maybe$Nothing;
	}
};
var author$project$Main$correctedBodyWeight = function (model) {
	...
	if ((!_n0.a.$) && (!_n0.b.$)) {
		var actual = _n0.a.a;
		var ideal = _n0.b.a;
		return elm$core$Maybe$Just(ideal + (0.4 * (actual - ideal)));
	} else {
		return elm$core$Maybe$Nothing;
	}
};
...
var author$project$Main$creatinineClearance = function (_n0) {
	...
	var age = _n0.A;
	var weight = _n0.s;
	var serumCreatinine = _n0.G;
	var _n1 = _Utils_Tuple3(age, weight, serumCreatinine);
	if (((!_n1.a.$) && (!_n1.b.$)) && (!_n1.c.$)) {
		var a = _n1.a.a;
		var w = _n1.b.a;
		var sc = _n1.c.a;
		var baseClearance = ((140 - a) * w) / sc;
		if (!sex) {
			return elm$core$Maybe$Just(baseClearance * 1.23);
		} else {
			return elm$core$Maybe$Just(baseClearance * 1.04);
		}
	} else {
		return elm$core$Maybe$Nothing;
	}
	...
	function (model, weight) {
		...
		if (_n0.$ === 1) {
			...
			var _n1 = function () {
				...
				return A3(elm$core$Tuple$mapBoth, f, f, perKg);
			}();
			var min = _n1.a;
			var max = _n1.b;
			return elm$core$Maybe$Just(
...
var author$project$Main$daily5mgDosageInstruction = F2(
	function (model, weight) {
		...
		if (_n0.$ === 1) {
			...
			var base = _n0.a.M;
			var initial = _n0.a.N;
			var following = _n0.a.Q;
			var note = _n0.a.S;
			var rangeStr = function (_n5) {
				var a = _n5.a;
				var b = _n5.b;
				return elm$core$String$fromInt(a) + ('-' + (elm$core$String$fromInt(b) + ' mg'));
			};
			var initialStr = function () {
				var _n4 = initial;
				var min = _n4.a;
				return elm$core$String$fromInt(min) + 'mg';
			}();
			var followingStr = function () {
				if (!following.b.$) {
					var hour = following.a;
					var _n3 = following.b;
					return 'Dose every ' + (elm$core$String$fromInt(hour) + ' hours');
				} else {
					var hour = following.a;
					var s = following.b.a;
					return 'At ' + (elm$core$String$fromInt(hour) + (' hours: ' + s));
				}
			}();
			return A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Initial dose: ' + initialStr)
							])),
						function () {
						if (note.$ === 1) {
							return A2(elm$html$Html$div, _List_Nil, _List_Nil);
						...
						_List_fromArray(
							[
								elm$html$Html$text(followingStr)
							]))
					]));
		}
	});
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Take gentamicin levels 6-14 hours after first dose')
							])),
						A2(
						elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								elm$html$Html$text('Compare level with Hartford nomogram to determine next dosage interval')
							]))
					]));
		}
	});
...
var author$project$Main$dividedDosageInstruction = F2(
	function (model, weight) {
		...
		var min = _n0.a;
		var max = _n0.b;
		var range = elm$core$String$fromInt(
			elm$core$Basics$round(min)) + ('-' + (elm$core$String$fromInt(
			elm$core$Basics$round(max)) + ' mg'));
		return A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(range + ' every 8 hours (from base dose of 3-5 mg/kg)')
						])),
					A2(
					elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text('After 1 hour, gentamicin levels should be 5-10 mg/L')
						])),
					A2(
					elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text('After 24 hours, gentamicin levels should be < 2 mg/L')
						]))
				]));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(author$project$Main$maybeToString, elm$core$String$fromInt, h)),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Serum Creatinine: ')
					])),
				A2(
				elm$html$Html$input,
				_List_fromArray(
					[
						elm$html$Html$Attributes$type_('number'),
						elm$html$Html$Attributes$value(scStr),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$type_('number'),
						elm$html$Html$Attributes$value(weightStr),
...
var author$project$Main$view = function (model) {
	...
	var outputs = _List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('Creatinine Clearance: ' + clearance)
				])),
			A2(
			elm$html$Html$div,
			_List_Nil,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(elm$html$Html$div, _List_Nil, outputs)
			]));
};
